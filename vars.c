...
/**
 * is_chain - function that tests current char
 * @info: the parameter struct
 * @buf: the char buffer
 * @p: address of current position
 *
 * eturn: 1 if chain delimeter, 0 otherwise
 */
...
/**
 * check_chain - fucntion that checks
 * @info: the parameter struct
 * @buf: the char buffer
 * @p: address of current position
 * @i: starting position
 ...
 * @info: the parameter struct
 *
 * Return: 1 returns if replaced, 0 otherwise
 */
